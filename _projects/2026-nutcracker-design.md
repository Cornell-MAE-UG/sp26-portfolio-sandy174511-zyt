...
<img src="https://latex.codecogs.com/svg.image?EIy=\iint&space;M&space;dx&space;dx=\begin{cases}1024.07x^3 + C_1x + C_2&\text{if }0<x<3\\3531.6x^2-65.4x^3 + C_3x + C_4&\text{if }3\leq x\leq18\end{cases}" style="vertical-align:middle" />
...
(C_1 = -9216.63,; C_2 = 0,; C_3 = -18433.26,; C_4 = 27649.89)

<img src="https://latex.codecogs.com/svg.image?y(x)=\begin{cases}\frac{1}{EI}(1024.07x^3-9216.63x)&space;&\text{if&space;}0<x<3\\\frac{1}{EI}(3531.6x^2-65.4x^3-18433.26x+27649.89)&space;&\text{if&space;}3\leq&space;x\leq&space;18\end{cases}" style="vertical-align:middle" />
...
<img src="https://latex.codecogs.com/svg.image?\delta_{max}=0.02\times18\text{cm}=0.36\text{cm}=0.0036\text{m}" style="vertical-align:middle" />

Using maximum deflection at (x=18):

<img src="https://latex.codecogs.com/svg.image?y_{max}\approx\frac{1}{EI}(1.12\times10^5)" style="vertical-align:middle" />

Thus:

<img src="https://latex.codecogs.com/svg.image?EI=\frac{1.12\times10^5}{0.0036}=3.11\times10^7\text{N·mm}^2" style="vertical-align:middle" />

With (E = 200\text{ GPa} = 2\times10^5\text{ N/mm}^2):

<img src="https://latex.codecogs.com/svg.image?I=\frac{3.11\times10^7}{2\times10^5}=155.5\text{ mm}^4" style="vertical-align:middle" />

Thus, a suitable cross section must have:

<img src="https://latex.codecogs.com/svg.image?\text{I}\geq155.5\text{ mm}^4" style="vertical-align:middle" />

A small W-shaped beam (or rectangular approximation) satisfying this:

* Example: rectangular section

  <img src="https://latex.codecogs.com/svg.image?I=\frac{bh^3}{12}" style="vertical-align:middle" />

Choosing (b=5\text{ mm}, h=10\text{ mm}):

<img src="https://latex.codecogs.com/svg.image?I=\frac{5(10)^3}{12}=416.7\text{ mm}^4" style="vertical-align:middle" />

This exceeds the required value, ensuring safety and minimal deflection.

Cross-sectional area:

<img src="https://latex.codecogs.com/svg.image?A=bh=50\text{ mm}^2" style="vertical-align:middle" />
